...
public class ExpandableListAdapter extends BaseExpandableListAdapter {
	ExpandableListAdapterListner myListener;
	ArrayList<Integer> expanded;
	ArrayList<Boolean> expandedHeaders;
	public interface ExpandableListAdapterListner{
    ...
    public void setHeaderChild(Context context, List<String> header, HashMap<String, List<String>> child)
    {
    	_context = context;
